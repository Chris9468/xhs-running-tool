...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border bg-card text-card-foreground shadow-[0_4px_20px_rgba(255,36,66,0.06)] transition-all duration-300 hover:shadow-[0_8px_30px_rgba(255,36,66,0.12)] hover:-translate-y-1",
      className
    )}
    {...props}
  />
